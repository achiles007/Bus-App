...
busApp.config(function($routeProvider) {
	...
	.when('/specialthanks',{
		...
		// controller: 'specialthanksController'
	})
...
//controllers
busApp.controller('bodyCtrl',['$scope','busStop', '$interval', '$window','$route', function($scope,busStop,$interval,$window,$route) {
...
busApp.controller('resultController',['$scope','$resource','busStop', '$http','$sce', function($scope,$resource,busStop,$http, $sce) {
...
// busApp.controller('aboutController',['$scope',function($scope) {$scope.good = 'good'}]);

// busApp.controller('informationController',['$scope',function($scope) {$scope.good = 'good'}]);

// busApp.controller('specialthanksController',['$scope',function($scope) {$scope.good = 'good'}]);
